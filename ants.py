...
# END Problem 13
    ...
    def action(self, colony):
        ...
        if self.is_true_queen:
            ...
            while next_exit:
                if next_exit.ant:
                    if not next_exit.ant.powered_up:
                        next_exit.ant.damage *= 2
                        next_exit.ant.powered_up = True
                    if next_exit.ant.is_container:
                        if next_exit.ant.contained_ant and not next_exit.ant.contained_ant.powered_up:
                            next_exit.ant.contained_ant.damage *= 2
                            next_exit.ant.contained_ant.powered_up = True
...
def make_scare(action, bee, duration = 2):
